...
void getAnimalName(Animal animal) {
    switch (animal) {
        case pig:
            std::cout << "Имя животного: Свинья" << '\n';
            break;
        case chicken:
            std::cout << "Имя животного: Курица" << '\n';
            break;
        case goat:
            std::cout << "Имя животного: Козел" << '\n';
            break;
        case cat:
            std::cout << "Имя животного: Кот" << '\n';
            break;
        case dog:
            std::cout << "Имя животного: Собака" << '\n';
            break;
        default:
            std::cout << "Ошибка: Такого животного нет" << '\n';
    }
}
...
void printNumberOfLegs(Animal animal) {
    switch (animal) {
        case pig:
            std::cout << "Количество лап: 4" << '\n';
            break;
        case chicken:
            std::cout << "Количество лап: 2" << '\n';
            break;
        case goat:
            std::cout << "Количество лап: 4" << '\n';
            break;
...
int findMax(int a, int b, int limit) {
    int maximum;
     ...
     if (maximum > limit) {
          return limit; // Если превышает - возвращаем предел (ограничение сверху)
     } else {
          return maximum; // Иначе возвращаем максимум
     }
}
...
int findMin(int a, int b, int limit) {
    ...
    if (minimum < limit) {
         return limit; // Если ниже, возвращаем предел (ограничение снизу)
    } else {
         return minimum; // Иначе возвращаем найденный минимум
    }
}
...
int main() {
    ...
    int n=nomZad();
                        ...
                        //Задание 4
                            ...
                            std::cout << "Задание №4 \n";
                            std::cout << '\n';
                            std::cout << "Введите номер животного от (1 - 5): ";
                            int nom;
                            std::cin >> nom;
                            // создаем переменную типа Animal и присваиваем ей значение
                            Animal myAnimal = static_cast<Animal>(nom);
                        ...
                        //Задание 7
                            ...
                            std::cout << "\nХотите ли вы выйти из торгового центра? (y/n): ";
